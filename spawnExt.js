        ...
        switch(spawn.memory.level) {
            ...
            case 1:
                ...
                if(currentHarvesters < minHarvesters) {
                    name = spawn.createCreep([WORK,WORK,CARRY,MOVE], undefined, { role: 'harvester', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                    ...
                    name = spawn.createCreep([WORK,WORK,CARRY,MOVE], undefined, { role: 'engineer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else {
                    name = spawn.createCreep([WORK,WORK,CARRY,MOVE], undefined, { role: 'upgrader', working: false, level: level, target:  spawn.room.name, home: spawn.room.name});
                }
                break;
            ...
            case 2: // 400
                ...
                if(currentMiners == 0) {
                    if(currentHarvesters == 0) {
                        ...
                        name = spawn.createCreep([WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'miner', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                    }
                } else if(currentMiners == 1 && currentChargers == 0) {
                    name = spawn.createCreep([CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'charger', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                    ...
                    name = spawn.createCreep([WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'engineer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else {
                    name = spawn.createCreep([WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'upgrader', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                }
                break;
            ...
            case 3: // 600
                ...
                if(currentMiners == 0) {
                    if(currentHarvesters == 0) {
                        ...
                        name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'miner', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                    }
                } else if(currentMiners == 1 && currentChargers == 0) {
                    name = spawn.createCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'charger', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentMiners < minMiners) {
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,CARRY,MOVE,MOVE], undefined, { role: 'miner', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentChargers < minChargers) {
                    name = spawn.createCreep([CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'charger', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentUpgraders < minUpgraders) {
                    ...
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'engineer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentArchitects < minArchitects) {
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'architect', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentExplorers < minExplorers) {
                    name = spawn.createCreep([WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE], undefined, { role: 'explorer', working: false, level: level, target: spawn.room.name, home: spawn.room.name, target: spawn.room.name, home: spawn.room.name});
                } else {
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'upgrader', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                }
                break;
            ...
            case 4: // 800
                ...
                if(currentMiners == 0) {
                    if(currentHarvesters == 0) {
                        ...
                        name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,MOVE], undefined, { role: 'miner', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                    }
                } else if(currentMiners == 1 && currentChargers == 0) {
                    name = spawn.createCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'charger', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentMiners < minMiners) {
                    ...
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE], undefined, { role: 'engineer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentArchitects < minArchitects) {
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE], undefined, { role: 'architect', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentExplorers < minExplorers) {
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE], undefined, { role: 'explorer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                }
                break;
            ...
            case 5: // 1000
                ...
                if(currentMiners == 0) {
                    if(currentHarvesters == 0) {
                        ...
                        name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,MOVE,MOVE], undefined, { role: 'miner', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                    }
                } else if(currentMiners == 1 && currentChargers == 0) {
                    name = spawn.createCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'charger', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentMiners < minMiners) {
                    ...
                    name = spawn.createCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'hauler', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentUpgraders < minUpgraders) {
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE], undefined, { role: 'upgrader', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentEngineers < minEngineers) {
                    name = spawn.createCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE], undefined, { role: 'engineer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                    ...
                    if(spawn.memory.flag == 0) {
                        name = spawn.createCreep([WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'explorer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                        spawn.memory.flag = 1;
                    } else {
                        name = spawn.createCreep([WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'explorer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                        spawn.memory.flag = 0;
                    ...
                    name = spawn.createCreep([CLAIM,WORK,WORK,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'claimer', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
            ...
            case 6: // 1500
                ...
                if(currentMiners == 0) {
                    ...
                    name = spawn.createCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], undefined, { role: 'hauler', working: false, level: level, target: spawn.room.name, home: spawn.room.name});
                } else if(currentUpgraders < minUpgraders) {
